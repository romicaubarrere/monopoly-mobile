...
void main() {
  ...
  testWidgets('cucha_pending_blocks_conflicting_actions_and_preserves_context', (
    tester,
  ) async {
    var emitted = 0;
  ...
  testWidgets('compact_cucha_remains_renderable_at_360dp_and_130_percent_text', (
    tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
        ...
        home: Center(
          child: SizedBox(
            ...
            child: MediaQuery(
              ...
              child: CuchaSurface(
                statusLabel:
                    'Seguís en la Cucha; elegí una salida confirmada por la partida.',
