...
void main() {
  testWidgets('property_offer_exposes_economy_and_group_without_board_traversal', (
    tester,
  ) async {
  ...
  testWidgets('pending_buy_blocks_conflicting_decline_and_keeps_offer_context', (
    tester,
  ) async {
    await tester.pumpWidget(
      _app(
  ...
  testWidgets('pending_decline_says_auction_is_opening_without_opening_it_locally', (
    tester,
  ) async {
    await tester.pumpWidget(
      _app(
  ...
  testWidgets('uncertain_compact_offer_freezes_actions_and_remains_renderable', (
    tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
