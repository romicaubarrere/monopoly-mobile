...
Future<void> main() async {
  ...
  _expect(
    ...
    'new kid must use one controlled refresh',
  );
  await _expectFailure(cache.certificateForKid('missing-kid'), 'unknown_kid');
  _expect(
    calls == 2,
    'fresh-cache misses must not replenish the refresh budget',
  );
